...
public partial class Incident_Details_User : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            command.CommandText = "SELECT [INC Incident Number] as 'Incident Number',[INC Status] as 'Status',[INC Priority] as 'Priority',[INC Tier 2] as 'Application',[INC DS Submitter Full Name] as 'Submitter',[AG Assignee] as 'Assignee',[Urgency_Reason] as 'Urgency Reason',[INC DS Submit Date] as 'Submit Date' ,[INC DS Last Modified Date] as 'Last Modified Date',[INC DS Last Resolved Date] as 'Last Resolved Date',[Expedite_Date] as 'Expedite Date',[INC Summary] as 'Summary',[Comment] as 'Comment' FROM [dbo].['All_Incidents'] FULL OUTER JOIN [dbo].[Expedite_time] ON [dbo].['All_Incidents'].[INC Incident Number] = [dbo].[Expedite_time].[Incident_ID] Where [INC Incident Number]='" + Incident + "' or [dbo].[Expedite_time].[Incident_ID]='" + Incident + "';";
