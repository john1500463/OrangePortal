...
<body>
  ...
  FTID Password</br> <asp:Label ID="message" runat="server" Text="" ></asp:Label></br></br>
        ...
        <div style="height: 100px;width: 100%;background-color: Black;margin-top: 150px;"> <br /> <font color="orange"  center  width="10"><center><b >For portal issues, contact us on
