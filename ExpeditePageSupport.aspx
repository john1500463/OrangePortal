...
<div id='cssmenu' style="min-width:900px; width:100%; top:0;">
...
<ul>
   ...
   <li><a href='Home_Page_Support.aspx' style="background: #FF6501;border-color: #FF6501;"><span>Home</span></a></li>
...
<script>
    ...
    <asp:Button ID="Button1" runat="server" Text="Save" OnClick="Button1_Click" />
        ...
        <br />
        <asp:LinkButton ForeColor="DarkOrange" id="Plaza_link" Text="Start a Discusion on Plazza" runat="server" OnClick="plazadiscussion_click" />
        <p>
